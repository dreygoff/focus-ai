...
interface EventLogDao {
    ...
    @Query("DELETE FROM event_log LEFT JOIN sessions ON sessions.id = event_log.sessionId WHERE sessions.id IS NULL AND timestamp < :beforeMillis")
...
interface AllowlistDao {
    ...
    suspend fun isAllowed(packageName: String): Int
}
