...
@NonNullApi
public class FocusProjectDependency extends DelegatingProjectDependency {

    @Inject
    public FocusProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
